...
class MySQLConnector implements DatabaseConnectorInterface
{
    ...
    public function row($sql, $args = [], $fetchMode = null)
    {
        ...
        return $this->execute($sql, $args)->fetch($fetchMode);
    }
    ...
    public function rows($sql, $args = [], $fetchMode = null)
    {
        ...
        return $this->execute($sql, $args)->fetchAll($fetchMode);
    }
    ...
    public function getRowById($id, $fetchMode = null)
    {
        ...
        return $this->execute("SELECT * FROM $this->table WHERE id = ?", [$id])->fetch($fetchMode);
    }
    ...
    public function insert(array $data)
    {
        ...
        $this->execute("INSERT INTO $this->table ($columns) VALUES ($placeholders)", $values);
    ...
    public function update(array $data, array $where): int
    {
        ...
        $stmt = $this->execute("UPDATE $this->table SET $fieldDetails WHERE $whereDetails", $values);
    ...
    public function delete(array $where, $limit = 1)
    {
        ...
        $stmt = $this->execute("DELETE FROM $this->table WHERE $whereDetails $limit", $values);
